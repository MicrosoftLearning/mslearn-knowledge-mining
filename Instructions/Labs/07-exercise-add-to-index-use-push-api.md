...
1. When deployment has finished, select **Go to resource group** to see all the resources that you've created.
    ...
    :::image type="content" source="../media/azure-resources-created-small.png" alt-text="A screenshot showing all of the deployed Azure resources." lightbox="../media/azure-resources-created.png":::
...
1. Copy the search service name into a text file.
    ...
    :::image type="content" source="../media/search-api-keys-exercise-version.png" alt-text="A screenshot of the keys section of a search service." lightbox="../media/search-api-keys-exercise-version.png":::
...
1. Uncomment lines 41 to 49.
    ...
    :::image type="content" source="../media/thread-code-ready-small.png" alt-text="A screenshot showing all the edited code." lightbox="../media/thread-code-ready.png":::
